...
import { ArrowRight, Layers3, LineChart, ShieldCheck } from "lucide-react";
      ...
      <div className="mx-auto w-full max-w-6xl px-6">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 leading-relaxed text-ink-muted">
            This is the operator&rsquo;s counterpart to the tenant-facing plane
            above — a separate store, consumer, and query path, sharing nothing
            with <code className="font-mono text-ink">f.Analytics()</code>.
          </p>
        </div>
