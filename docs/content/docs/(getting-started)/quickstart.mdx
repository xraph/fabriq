...
`domain.RegisterAll` registers the TWINOS pack. You can register your own `registry.EntitySpec` set instead — the rest of this page assumes the `site` and `asset` entities from that pack.
