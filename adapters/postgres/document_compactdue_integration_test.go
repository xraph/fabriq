...
// Compact GCs CRDT tombstones behind the safety horizon while persisting
// the snapshot: a list element inserted and deleted well before the
// horizon disappears from the compacted state entirely; fresh content
// survives.
